; JSSatchell Media
; As demonstrated in this video: https://youtu.be/-09jKyg-uec
...
;Set search area based on mouse position
bound1X := ogx-50
bound1Y := ogy-50
bound2X := ogx+2000
bound2Y := ogy+50

;Set the amount of hue variation to search for and the amount of compensation to add back to the click-point
variation = 5
comp := variation*.8

;Set keyboard shortcut if wanted
;^h::
...
if ErrorLevel
{
	;Sometimes the curve is at full brightness and sometimes it's dimmed for some reason so this will search for the dimmer hue if the full hue isn't found
...
;return if using as keyboard shortcut
;return
